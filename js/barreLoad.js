...
$('#bootstrap').click(function(){
	...
	function rafraichir(){
	    if(pourcent < 100){
	    	pourcent=pourcent+0.5;
	    	var largeurbarreHtml = largeurbarre*(pourcent/100);
	        $('#barreInt').css('width',largeurbarreHtml).html('Apprentissage en cours...'); // on incrémente la valeur de 1 si elle est strictement inférieure à 100
		setTimeout(rafraichir, 0.5);
...
$('#symfony').click(function(){
	...
	function rafraichir(){
	    if(pourcent < 100){
	    	pourcent=pourcent+0.5;
	    	var largeurbarreHtml = largeurbarre*(pourcent/100);
	        $('#barreDev').css('width',largeurbarreHtml).html('Apprentissage en cours...'); // on incrémente la valeur de 1 si elle est strictement inférieure à 100
		setTimeout(rafraichir, 0.5);
...
$('#ai').click(function(){
	...
	function rafraichir(){
	    if(pourcent < 100){
	    	pourcent=pourcent+0.5;
	    	var largeurbarreHtml = largeurbarre*(pourcent/100);
	        $('#barreInfo').css('width',largeurbarreHtml).html('Apprentissage en cours...'); // on incrémente la valeur de 1 si elle est strictement inférieure à 100
		setTimeout(rafraichir, 0.5);
